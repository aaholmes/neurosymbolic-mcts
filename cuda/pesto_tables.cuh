...
// ============================================================
// PeSTO evaluation tables in GPU constant memory
//
// Pre-computed with color flip + base piece values.
// Indexed as c_MG_PESTO[color*6 + piece_type][square].
//
// Color-flip logic (from src/eval.rs):
//   WHITE: table[sq] = VALUE[p] + PST[p][sq ^ 56]
//   BLACK: table[sq] = VALUE[p] + PST[p][sq]
//
// Source values from src/eval_constants.rs (RofChade PeSTO).
// ============================================================

// Phase contribution per piece type: P=0, N=1, B=1, R=2, Q=4, K=0
__constant__ int32_t c_PHASE_WEIGHT[6] = {0, 1, 1, 2, 4, 0};

// Raw piece values (for reference)
__constant__ int32_t c_MG_VALUE[6] = {82, 337, 365, 477, 1025, 0};
__constant__ int32_t c_EG_VALUE[6] = {94, 281, 297, 512, 936, 0};

// ============================================================
// Pre-computed MG PeSTO tables [12][64]
// ============================================================
__constant__ int32_t c_MG_PESTO[12][64] = {
    // [0] WHITE PAWN
...
// ============================================================
// Pre-computed EG PeSTO tables [12][64]
// ============================================================
__constant__ int32_t c_EG_PESTO[12][64] = {
    // [0] WHITE PAWN
